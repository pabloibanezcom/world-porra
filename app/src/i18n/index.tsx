...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'groupPrediction.awarded': 'Awarded',
    'groupPrediction.projected': 'Projected',
    ...
    'league.deleteWord': 'delete',
    'league.deleteInputLabel': ({ word }) => `Type "${word}" to confirm`,
    ...
    'predictionSheet.useJoker': '🃏 Play Joker',
    'predictionSheet.removeJoker': '🃏 Remove Joker',
    'predictionSheet.jokerUsed': '🃏 Joker already used this stage',
    'predictionSheet.jokerHint': 'Doubles the total points you earn on this match. One joker per stage.',
    'predictionSheet.jokerActiveHint': 'Joker active — points on this match are doubled.',
    'predictionSheet.jokerLockedHint': 'You can only play one joker per stage.',
    'matchCard.joker': '🃏 JOKER ×2',
    ...
    'member.noGroupPicks': 'No group predictions yet.',
    'member.noFinalPicks': 'No final-stage picks yet.',
    'member.pointsBreakdown': 'Points breakdown',
    'member.matchPoints': 'Matches',
    'member.groupPoints': 'Groups',
    'member.tournamentPoints': 'Tournament',
  ...
  es: {
    ...
    'stage.ROUND_OF_32': 'Dieciseisavos',
    'stage.ROUND_OF_16': 'Octavos',
    'stage.QUARTER_FINAL': 'Cuartos de final',
    'stage.SEMI_FINAL': 'Semifinales',
    ...
    'groupPrediction.awarded': 'Otorgados',
    'groupPrediction.projected': 'Proyectados',
    ...
    'league.deleteWord': 'eliminar',
    'league.deleteInputLabel': ({ word }) => `Escribe "${word}" para confirmar`,
    ...
    'predictionSheet.useJoker': '🃏 Usar comodín',
    'predictionSheet.removeJoker': '🃏 Quitar comodín',
    'predictionSheet.jokerUsed': '🃏 Comodín ya usado en esta fase',
    'predictionSheet.jokerHint': 'Duplica los puntos totales que ganes en este partido. Un comodín por fase.',
    'predictionSheet.jokerActiveHint': 'Comodín activo: los puntos de este partido se duplican.',
    'predictionSheet.jokerLockedHint': 'Solo puedes usar un comodín por fase.',
    'matchCard.joker': '🃏 COMODÍN ×2',
    ...
    'member.adminView': 'Admin',
    'member.noGroupPicks': 'Aún no hay pronósticos de grupos.',
    'member.noFinalPicks': 'Aún no hay pronósticos de fases finales.',
    'member.pointsBreakdown': 'Desglose de puntos',
    'member.matchPoints': 'Partidos',
    'member.groupPoints': 'Grupos',
    'member.tournamentPoints': 'Torneo',
