...
const APP_PATH = process.env.NEXT_PUBLIC_APP_URL ?? '/app';
      ...
      <nav className="top">
        <div className="wrap row">
          ...
          <div className="links">
            ...
            <a href="https://github.com/pabloibanezcom/wc2026-pool" target="_blank" rel="noopener noreferrer" className="icon-link" aria-label="GitHub repository" title="View source on GitHub">
            ...
            <a href={APP_PATH} className="pill dark sm">{t.nav_open}</a>
          </div>
        </div>
      </nav>
